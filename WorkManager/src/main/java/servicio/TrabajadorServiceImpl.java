...
import repositorios.UsuarioRepository; // Asegúrate de que el nombre del paquete coincida
import repositorios.RolRepository;     // Asegúrate de que el nombre del paquete coincida
...
public class TrabajadorServiceImpl implements TrabajadorService {
    ...
    public void save(Trabajador trabajador) {
        ...
        if (!usuarioRepository.existsByUsername(usernameLimpio)) {
            ...
            // 6. Guardamos el usuario con sus roles asociados
